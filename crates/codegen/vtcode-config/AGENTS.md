...
- `constants::tool_limits` is the source of truth: normal tool loops default to 40, planning/approved-plan floors are 60, `0` remains unlimited, and extensions cap at 240; `agent.max_conversation_turns` remains context retention only.
