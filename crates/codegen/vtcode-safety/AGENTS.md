...
- Sandboxed pipe/PTy and MCP stdio launches filter sensitive environment names after overrides; macOS hostname allowlists reject unenforceable policies, unsupported Windows restrictions fail closed, and `SensitivePath` matching is case-insensitive with component-boundary semantics.
