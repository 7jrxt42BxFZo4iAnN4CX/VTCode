...
- Approved-plan turns apply one bounded internal loop allowance at initialization; auto-permission probe warnings stay queued until the assistant tool batch is complete, then flush before recovery directives.
